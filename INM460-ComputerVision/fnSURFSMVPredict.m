%fnSURFSMVPredict(SURFSVMMdl, SURFPointsSave, img)
...
% label = fnSURFSMVPredict(SURFSVMMdl, 30, I);
%
function label = fnSURFSMVPredict(SURFSVMMdl, SURFPointsSave, I)
    ...
    f = f(:);
    label = predict(SURFSVMMdl.SURFSVMMdl_70px_50pt, f');
end